...
" -mã đơn- -số lượng- -đơn vị- ",
    ...
    " -mã đơn- -số lượng- -đơn vị- ",
    " -mã đơn- -số lượng- -đơn vị- ",
    " -mã đơn- -số lượng- -đơn vị- -mã đơn- ",
    "  -mã đơn- -số lượng- -đơn vị-",
    "  -mã đơn- -số lượng- -đơn vị-",
    " -mã đơn- -số lượng- -đơn vị- ",
    " đặt -mã đơn- -số lượng- -đơn vị- ",
    " -mã đơn- -số lượng- -đơn vị-",
    "  -mã đơn- -số lượng- -đơn vị-",
    " -mã đơn- -số lượng- -đơn vị- 37 QL13, ",
    " -mã đơn- -số lượng- -đơn vị- 399/3 Tôn Đức Thắng, ",
    " -mã đơn- -số lượng- -đơn vị- 287 Đường 30/04, Trà Vinh",
    " -mã đơn- -số lượng- -đơn vị- 192 Nguyễn Công Trứ, Cần Thơ",
    " mã -mã đơn-",
    " mã -mã đơn-",
    "  -mã đơn-",
