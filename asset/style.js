...
" -mã đơn- -số lượng- -đơn vị- -số lượng-**** sđt  ",
"-số lượng- -đơn vị-  -số lượng-",
"cho e -số lượng- -đơn vị- -mã đơn- -số lượng-**-số lượng- ",
"cho cô -mã đơn- -số lượng- -đơn vị-  -số lượng-**********",
"cô lấy -mã đơn- -số lượng- -đơn vị-  -số lượng-**********",
"cô mua thêm -mã đơn-  -số lượng- -đơn vị-  -số lượng-**********",
"cô dồn đơn cũ với -mã đơn-  -số lượng- -đơn vị-  -số lượng-**********",
"cho chị -mã đơn- -số lượng- -đơn vị- *********** -icon-",
"chị đặt -mã đơn- -số lượng- -đơn vị- -số lượng-*********",
"a lấy -mã đơn- -số lượng- -đơn vị- **********",
"cho em thêm -mã đơn- -số lượng- -đơn vị- -số lượng-********** -icon-",
"chị gom chung -mã đơn- -số lượng- -đơn vị- ************",
"lấy cho cô -mã đơn- -số lượng- -đơn vị- -số lượng-********",
"em chốt -mã đơn- -số lượng- -đơn vị- ************",
"chị mua -mã đơn- -số lượng- -đơn vị- -số lượng-**********",
"bác lấy thêm -mã đơn- -số lượng- -đơn vị- *********** -icon-",
"dồn giúp chị -mã đơn- -số lượng- -đơn vị- -số lượng-**********",
...
"chốt -số lượng- -đơn vị- -mã đơn- -số lượng-**********",
"chị gom chung -mã đơn- -số lượng- -đơn vị- ***********",
"cho em lại -mã đơn- -số lượng- -đơn vị- **********",
"chị đặt thêm -mã đơn- -số lượng- -đơn vị- **********",
"em lấy -mã đơn- -số lượng- -đơn vị- ************",
"gộp luôn -mã đơn- -số lượng- -đơn vị- -số lượng-*********",
...
"lấy giúp chị -mã đơn- -số lượng- -đơn vị- *********** ",
"cô lấy thêm -mã đơn- -số lượng- -đơn vị- ************",
"Bác đặt thêm -mã đơn- -số lượng- -đơn vị- -số lượng-*********",
"chị mua thêm -mã đơn- -số lượng- -đơn vị- **********",
"lấy cho em -mã đơn- -số lượng- -đơn vị- ************",
"-mã đơn- -đơn vị- -số lượng- Quốc Lộ -số lượng-, Hiệp Bình Phước, Thủ Đức gửi về chỗ cũ đi",
"-mã đơn- -đơn vị- -số lượng- Tôn Đức Thắng, Ngũ Hành Sơn, Đà Nẵng, về địa chỉ cũ ",
"-mã đơn- -đơn vị- -số lượng- Đường -số lượng-/-số lượng-, P8, Trà Vinh, giao tới chỗ cũ",
"-mã đơn- -đơn vị- -số lượng- Nguyễn Công Trứ Cái Khế Ninh Kiều Cần Thơ cứ ship đến chỗ cũ",
"-mã đơn- -đơn vị- -số lượng- Võ Văn Tần, Q3, TP.HCM, lấy giúp nhé sđt **************",
"-mã đơn- -đơn vị- sđt ************** -số lượng- Lê Đại Hành, P5, Bạc Liêu, cứ gửi về chỗ cũ nha",
"-mã đơn- -đơn vị- -số lượng- Trần Phú, Cà Mau sđt ************** giao đúng địa cũ là được",
"-mã đơn- -đơn vị- -số lượng- Hoàng Diệu, P5, Cần Thơ  ship như mọi khi nhé sđt **************",
"-mã đơn- -đơn vị- -số lượng- Võ Thị Sáu, Biên Hòa, Đồng Nai cứ theo địa cũ giao nha Thu sđt **************",
"-mã đơn- -đơn vị- -số lượng- Phạm Văn Đồng, Vĩnh Hòa, Nha Trang, giao nhanh theo địa cũ nhé",
"-mã đơn- -đơn vị- -số lượng- Lý Tự Trọng, Hải Châu, Đà Nẵng, gửi luôn đi, đừng gọi",
"-mã đơn- -đơn vị- -số lượng- Nguyễn Đình Chiểu, Đà Lạt, cứ địa cũ mà giao",
"-mã đơn- -đơn vị- -số lượng- Nguyễn An Ninh, Pleiku, Gia Lai, gọi không cần, sđt ************",
"-mã đơn- -đơn vị- -số lượng- Phan Bội Châu, Hội An, Quảng Nam SDT *************** ship tới như cũ",
"-mã đơn- -đơn vị- -số lượng- Hoàng Văn Thụ, Nam Định, gửi tới đúng địa cũ là được SDT *************** ",
"-mã đơn- -đơn vị- -số lượng- Nguyễn Thị Minh Khai, Q1, TP.HCM, giao lại địa cũ nhé SDT *************** ",
"-mã đơn- -đơn vị- SDT ***************  -số lượng- Trường Chinh, Bình Tân, TP.HCM giao về chỗ cũ của cô nha con",
"SDT ***************  -mã đơn- -đơn vị- -số lượng- Nguyễn Huệ, P2, Quy Nhơn ship tới chỗ cũ nha",
"-mã đơn- -đơn vị- -số lượng- Lê Hồng Phong, P3, Bến Tre SDT ***************  cứ gửi về địa cũ cho nhanh",
"-mã đơn- -đơn vị- -số lượng- Lê Duẩn, Ba Đình, Hà Nội, không cần gọi ",
"SDT ***************  -mã đơn- -đơn vị- -số lượng- Nguyễn Văn Cừ, An Hòa, Ninh Kiều, Cần Thơ, giao đúng địa chỉ cũ",
"-mã đơn- -đơn vị- -số lượng- Hoàng Hoa Thám, Nghĩa Lộ, Quảng Ngãi, ship về nhanh đi",
"-mã đơn- -đơn vị- -số lượng- Lê Lợi, P4, Vũng Tàu, địa cũ nhé SDT *************** ",
"-mã đơn- -đơn vị- -số lượng- Nguyễn Thị Định, Đông Ba, Huế, giao như cũ nha",
"-mã đơn- -đơn vị- -số lượng- Phan Văn Trị, Gò Vấp, TP.HCM, giao luôn không cần gọi",
"Lấy chị -số lượng- -đơn vị- -mã đơn- ",
...
"-mã đơn- -số lượng- -đơn vị- nhé -icon-",
...
"-icon-",
"Lấy chị -số lượng- -đơn vị- -mã đơn-  -icon-",
"-icon-",
"-số lượng- -đơn vị- -mã đơn- *********** -icon-",
"-số lượng- -đơn vị- -mã đơn- cho chị ************",
" lấy -số lượng- -đơn vị- -mã đơn- cho em ***********",
" -mã đơn-/ -số lượng-***** -icon-",
"-số lượng-********/-mã đơn- -đơn vị- -icon-",
"-số lượng-********* -số lượng--đơn vị-/-mã đơn-",
"Cô mua -mã đơn-h -số lượng- -đơn vị- ************",
" ************ -mã đơn-",
" -mã đơn- dồn đơn ************",
...
"Cô chốt -số lượng- -đơn vị- -mã đơn- nha Thu *************",
"Anh -số lượng- -đơn vị- -mã đơn- nha Thu *************",
"C cần mã -mã đơn-, -số lượng- -đơn vị- nha em -icon- *************",
"Anh lấy mã -mã đơn-, -số lượng- -đơn vị- nha -icon- *************",
"-icon- *************",
"Anh cần -số lượng- -đơn vị- mã -mã đơn- nhé Thu -icon- *************",
"Thu ơi, chốt giùm E -số lượng- -đơn vị- -mã đơn- -icon- *************",
"-mã đơn- /-số lượng--mã đơn- *************",
"-mã đơn- -số lượng-/-đơn vị- *************",
"-mã đơn- -số lượng- -đơn vị- nha e *************",
"Cô cần -số lượng- -đơn vị- mã -mã đơn- nha em *************",
...
"-mã đơn- -số lượng- -đơn vị- *************",
"lấy luôn cho e mã -mã đơn- *************",
"mã -mã đơn- -số lượng- -đơn vị- -icon- *************",
"mã -mã đơn- sđt ************",
"Mã -mã đơn- -đơn vị- Sđt *************",
"cho chị -mã đơn- *************",
"-icon- *************",
...
"mua hàng nhà chị nhiều quá rồi mà ưng lắm lấy e thêm mã -mã đơn- nha *************",
"chốt chị mã -mã đơn-  *************",
"cho chị -số lượng- -đơn vị- mã -mã đơn- -icon- *************",
"-mã đơn- -số lượng- -mã đơn-  *************",
