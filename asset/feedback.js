...
const categories = {
    "tu-thien":[
            ...
            "Thật sự ngưỡng mộ",
            "A di đà phật",
            "Chị Thu là niềm cảm hứng của em",
            "💞💞💞",
            "Đáng yêu ghê",
            "Cảm ơn tấm lòng vàng của vợ chồng anh chị",
            "Cảm phục tấm lòng của chị Thu",
            "Cảm động không nói nên lời",
            "Việc làm của anh chị thật tuyệt vời",
            "Tấm lòng của anh chị thật đáng trân quý",
            "🌹🌹🌹",
            "Chị khiến em thấy ấm áp lắm",
            "Rất đáng quý",
            "Em nghẹn ngào luôn",
            "Chị Thu sống rất đẹp",
            "Yêu lắm luôn",
            "💌💌💌",
            "Thích quá trời",
            "Cảm động quá trời",
            "Thật biết ơn chị Thu",
            "Chúc vkck em ngày càng phát triển",
            "🫶🫶🫶",
            "Tâm huyết của chị Thu khiến em xúc động",
            "Thương anh chị rất nhiều",
            "Cảm ơn chị Thu vì tấm lòng vàng",
            "Thật ngưỡng mộ chị Thu Lê",
            "Quá tuyệt vời",
            "Rất xịn sò",
            "❤️‍🔥❤️‍🔥",
            "Anh chị là tấm gương sáng cho mọi người",
            "Ngưỡng mộ ghê",
            "Cảm động lắm luôn",
            "Chúc vkck anh chị gặp nhiều may mắn",
            "💓💓💓",
            "Chị xứng đáng được yêu mến nhiều hơn",
            "Thật xúc động với việc chị làm",
            "Chị Thu Lê là người tuyệt vời",
            "Không biết nói gì luôn",
            "Thật sự cảm động trước anh chị",
            "Đỉnh của đỉnh",
            "Việc làm của anh chị làm em xúc động",
            "✨✨✨",
            "Chị khiến em trân trọng hơn cuộc sống",
            "Tấm lòng của chị Thu quá lớn",
            "Chị Thu lúc nào cũng tử tế",
            "Cảm ơn sự tử tế của anh chị",
            "Quá xuất sắc",
            "Thương lắm luôn",
            "💖💖💖",
            "Tuyệt vời quá",
            "Em xúc động ghê",
            "Anh chị làm em khâm phục",
            "Chị Thu thật sự là người đặc biệt",
            "Em khóc mất rồi",
            "Việc chị làm rất ý nghĩa",
            "Chị Thu làm em rất cảm động",
            "Yêu quý chị Thu vô cùng",
            "Quá ý nghĩa luôn",
            "💕💕💕",
            "Quá xuất sắc",
            ...
            "Mãi ủng hộ",
            "Đẹp quá đi",
            "Cảm ơn vì tất cả anh chị đã làm",
            "Anh chị đúng là người tốt",
            "Tâm đức lắm",
            "Yêu thương anh chị nhiều lắm",
            "Cảm ơn anh chị đã mang yêu thương đến mọi người",
            "Thật tuyệt khi biết anh chị",
            "Không thể tin nổi",
            "Thật cảm động quá",
            "Rất xịn sò",
            "Chị Thu Lê sống vì cộng đồng",
            "Rất đáng quý",
            "Chúc vkck anh chị thành công và hạnh phúc",
            "Việc chị làm khiến em thấy ấm áp",
            "Chị làm em rất xúc động",
            "Chúc chị Thu Lê luôn vui vẻ và hạnh phúc",
            "💝💝💝",
            "Anh chị lúc nào cũng sống hết lòng",
            "Chị làm em khâm phục quá",
            "Chị khiến em yêu đời hơn",
            "Yêu chị Thu mãi",
            "Việc làm của chị Thu đầy ý nghĩa",
            "Em cảm động sâu sắc",
            "Chị thật tuyệt vời",
